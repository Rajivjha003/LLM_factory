...
|---|---:|---:|---:|---:|
| required_terms_score | 0.578 | 0.000 | 1.000 | 13/50 |
...
| interpretation_score | 0.976 | 0.200 | 1.000 | 48/50 |
| structure_score | 0.969 | 0.200 | 1.000 | 46/50 |

## Suspicious Cases

- Failed but score_rate >= 0.90: 19
...
| bq_debug_v3_007 | 0.941 | ['OrderNbr'] | ["Missing required terms: ['OrderNbr']"] |
| bq_debug_v3_008 | 0.912 | ['GROUP BY', 'HAVING COUNT'] | ["Missing required terms: ['GROUP BY', 'HAVING COUNT']"] |
...
| retail_metric_v3_007 | 0.941 | ['%'] | ["Missing required terms: ['%']"] |
| safety_v3_001 | 0.912 | ['validate'] | ["Missing required terms: ['validate']"] |
| safety_v3_004 | 0.941 | ['validate'] | ["Missing required terms: ['validate']"] |
| sql_gen_v3_002 | 0.956 | ['HAVING COUNT'] | ["Missing required terms: ['HAVING COUNT']"] |
| sql_gen_v3_003 | 0.956 | ['CREATE OR REPLACE TABLE'] | ["Missing required terms: ['CREATE OR REPLACE TABLE']"] |
